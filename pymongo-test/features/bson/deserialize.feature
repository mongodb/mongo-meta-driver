...
Feature: Deserialize Elements
  ...
  @ruby @python
  Scenario Outline: Deserialize singleton BSON objects (universal)
  ...
  @ruby
  Scenario Outline: Deserialize singleton BSON objects (Ruby only)
    Given an IO stream containing <hex_bytes>
    When I deserialize the stream
    Then the result should be the <type> value <value>
  ...
  @ruby @python
  Scenario Outline: Deserialize binary values (universal)
    Given an IO stream containing <hex_bytes>
    When I deserialize the stream
  ...
  @ruby
  Scenario Outline: Deserialize binary values (Ruby only)
    Given an IO stream containing <hex_bytes>
    When I deserialize the stream
    Then the result should be the binary value <value> with binary type <binary_type>
